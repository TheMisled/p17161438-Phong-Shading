...
void SceneDiffuse::setLightParams(QuatCamera camera)
{
	...
	prog.setUniform("light.Ld", 0.9f, 0.9f, 0.9f);//what elements does Ld have?
	prog.setUniform("light.La", 0.3f, 0.3f, 0.3f);
	prog.setUniform("light.Ls", 0.3f, 0.3f, 0.3f);

	prog.setUniform("light.attenconst", 1.f);
	prog.setUniform("light.attenlin", 0.f);
	prog.setUniform("light.attenquad", 0.f);
...
void SceneDiffuse::render(QuatCamera camera)
{
	...
	prog.setUniform("material.Kd", 0.51f, 1.0f, 0.49f); // What elements does Kd have?
	prog.setUniform("material.Ks", 0.1f, 0.1f, 0.1f);
	prog.setUniform("material.Ka", 0.51f, 1.f, 0.49f);
	prog.setUniform("specPwr", 1.0f);
	...
	//Now set up the teapot 
	 ...
	 prog.setUniform("material.Kd", 0.46f, 0.29f, 0.0f); // What elements does Kd have?
	 prog.setUniform("material.Ks", 0.29f, 0.29f, 0.29f);
	 prog.setUniform("material.Ka", 0.46f, 0.29f, 0.0f);
	 prog.setUniform("specPwr", 64.0f);
